package net.yxiao233.realmofdestiny.screen.renderer;
...
public class FluidTankRenderer {
    ...
    public final int tankPixelHeight;
    ...
    public FluidTankRenderer(long capacity, boolean showCapacity, int width, int height, int tankPixelHeight) {
        this(capacity, showCapacity ? TooltipMode.SHOW_AMOUNT_AND_CAPACITY : TooltipMode.SHOW_AMOUNT, width, height, tankPixelHeight);
    }

    private FluidTankRenderer(long capacity, TooltipMode tooltipMode, int width, int height, int tankPixelHeight) {
        ...
        this.width = width;
        this.height = height;
        this.tankPixelHeight = tankPixelHeight;
    }
    ...
    private void drawFluid(PoseStack poseStack, final int width, final int height, FluidStack fluidStack) {
        ...
        long scaledAmount = (amount * tankPixelHeight) / capacity;
    ...
    public List<Component> getTooltip(FluidStack fluidStack, TooltipFlag tooltipFlag) {
        ...
        try {
            ...
            if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
                MutableComponent amountString = Component.translatable("tooltip.realmofdestiny.liquid.amount.with.capacity", nf.format(milliBuckets), nf.format(capacity));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
                MutableComponent amountString = Component.translatable("tooltip.realmofdestiny.liquid.amount", nf.format(milliBuckets));
                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
            }
